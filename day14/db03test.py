...
class Mywinget(QWidget):   #위젯을 해서 한가운데 넣기만 하면 끝나요. 
    def __init__(self):
        super().__init__() #가운데에 위젯을 만들어 하면 한 가운데 들어감 
class MyRegisterWindow(QMainWindow):
    def __init__(self, parent):
        super().__init__(parent)
        self.initUI()   #그냥 창 개념으로 큰 창, 작은창 할 수 있음. 
        #클래스로 만들어서 호출해도 됨. 
        
    
    def initUI(self):
        self.setGeometry(50,50,500,600) #타이틀 껍데기가 없는 애니까
