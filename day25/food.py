...
### 음식점 종류 
# for j in range(1,21):
#     ulElem1= browser.find_element_by_css_selector("#place_main_ct > div > div > div.sc_box.place_list > div.list_area > ul")
#     lists1=store.find_element_by_css_selector("category")
#     for store1 in lists1:
#         print(store.find_element_by_css_selector(".list_item").txt)
#     pyautogui.click(765,580)
