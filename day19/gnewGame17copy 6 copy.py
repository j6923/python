...
while isRunning:
    ...
    if cnt %4 == 0:
        screen.blit(enemyship0,(ex,ey))
    elif cnt %4 == 1:
        screen.blit(enemyship1,(ex,ey))
    elif cnt %4 == 2:
...
#클릭하면 append 
    ...
    screen.blit(enemyship0,(100,200))
    screen.blit(enemyship1,(100,200))
    screen.blit(enemyship2,(100,200))
    screen.blit(enemyship3,(100,200))
